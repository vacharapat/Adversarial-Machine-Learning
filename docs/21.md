...
$$
\begin{split}
m&= \frac{2}{\epsilon}\left(d\log2\frac{2em}{d}+\log2\frac{2}{\delta}\right)\\
&=\frac{2}{\epsilon}\left(d\log2m+d\log2\frac{2e}{d}+\log2\frac{2}{\delta}\right)\\
&=\frac{2d}{\epsilon}\log2m+\frac{2}{\epsilon}\left(d\log2\frac{2e}{d}+\log2\frac{2}{\delta}\right)
\end{split}
$$

คราวนี้เราจะจำกัดขอบเขตของค่า $\log_2 m$ ดังนี้ พิจารณาฟังก์ชัน $y_1=\log2x$ และฟังก์ชันเส้นตรง $y_2=ax+b$ ที่แตะกันที่จุด $x=\alpha$ ดังรูป
...
$$
a = \left.\frac{\text{d}}{\text{d} x}\log2x\right|_\alpha = \left.\frac{1}{x\ln 2}\right|_\alpha = \frac{1}{\alpha\ln2}
$$
