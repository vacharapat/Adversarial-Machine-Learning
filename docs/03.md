...
จากตัวอย่างรูปหมูเดิม เมื่อทดลองกำหนดเป้าหมายเป็นคลาสของเครื่องบิน และทำ projected gradient descent โดยใช้ learning rate เป็น $$5\times 10^{-3}$$ ปรากฏว่าหลังจากรันไป 100 รอบก็สามารถทำให้ ResNet50 ทำนายว่ารูปที่ถูกก่อกวนเป็นเครื่องบินด้วยความน่าจะเป็น 0.968 โดยที่รูปที่ถูกก่อกวนเป็นดังนี้
